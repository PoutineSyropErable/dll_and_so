...
0000000000000378 <.note.gnu.build-id>:
 ...
 387:	00 b8 e7 45 2e 9b    	add    %bh,-0x64d1ba19(%rax)
 38d:	68 15 ec 1e bc       	push   $0xffffffffbc1eec15
 392:	c6                   	(bad)
 393:	ff 10                	call   *(%rax)
 395:	7a dd                	jp     374 <_init-0xc8c>
 397:	9c                   	pushf
 398:	0d                   	.byte 0xd
 399:	cb                   	lret
 39a:	02                   	.byte 0x2
...
00000000000003e0 <.dynsym>:
 ...
 427:	00 7a 00             	add    %bh,0x0(%rdx)
 42a:	00 00                	add    %al,(%rax)
 42c:	22 00                	and    (%rax),%al
	...
 43e:	00 00                	add    %al,(%rax)
 440:	68 00 00 00 12       	push   $0x12000000
	...
 455:	00 00                	add    %al,(%rax)
 457:	00 46 00             	add    %al,0x0(%rsi)
 ...
 488:	1d 00 00 00 20       	sbb    $0x20000000,%eax
	...
...
00000000000004b8 <.dynstr>:
 4b8:	00 5f 49             	add    %bl,0x49(%rdi)
 4bb:	54                   	push   %rsp
 4bc:	4d 5f                	rex.WRB pop %r15
 4be:	64 65 72 65          	fs gs jb 527 <_init-0xad9>
 ...
 4d0:	61                   	(bad)
 4d1:	62 6c 65 00 5f       	(bad)
 4d6:	5f                   	pop    %rdi
 4d7:	67 6d                	insl   (%dx),%es:(%edi)
 4d9:	6f                   	outsl  %ds:(%rsi),(%dx)
 4da:	6e                   	outsb  %ds:(%rsi),(%dx)
 4db:	5f                   	pop    %rdi
 4dc:	73 74                	jae    552 <_init-0xaae>
 4de:	61                   	(bad)
 4df:	72 74                	jb     555 <_init-0xaab>
 4e1:	5f                   	pop    %rdi
 4e2:	5f                   	pop    %rdi
 4e3:	00 5f 49             	add    %bl,0x49(%rdi)
 4e6:	54                   	push   %rsp
 4e7:	4d 5f                	rex.WRB pop %r15
 4e9:	72 65                	jb     550 <_init-0xab0>
 ...
 4ff:	5a                   	pop    %rdx
 500:	31 30                	xor    %esi,(%rax)
 502:	61                   	(bad)
 503:	64 64 4e 75 6d       	fs fs rex.WRX jne 575 <_init-0xa8b>
 508:	62 65 72 73 69       	(bad)
 50d:	69 00 5f 5a 31 30    	imul   $0x30315a5f,(%rax),%eax
 513:	73 75                	jae    58a <_init-0xa76>
 515:	62 4e 75 6d 62       	(bad)
 51a:	65 72 73             	gs jb  590 <_init-0xa70>
 51d:	69 69 00 5f 5f 6c 69 	imul   $0x696c5f5f,0x0(%rcx),%ebp
 524:	62 63 5f 73 74       	(bad)
 529:	61                   	(bad)
 52a:	72 74                	jb     5a0 <_init-0xa60>
 52c:	5f                   	pop    %rdi
 52d:	6d                   	insl   (%dx),%es:(%rdi)
 52e:	61                   	(bad)
 52f:	69 6e 00 5f 5f 63 78 	imul   $0x78635f5f,0x0(%rsi),%ebp
 536:	61                   	(bad)
 537:	5f                   	pop    %rdi
 538:	66 69 6e 61 6c 69    	imul   $0x696c,0x61(%rsi),%bp
 53e:	7a 65                	jp     5a5 <_init-0xa5b>
 540:	00 70 72             	add    %dh,0x72(%rax)
 543:	69 6e 74 66 00 6c 69 	imul   $0x696c0066,0x74(%rsi),%ebp
 54a:	62 6d 61 74 68       	(bad)
 54f:	2e 73 6f             	jae,pn 5c1 <_init-0xa3f>
 552:	00 6c 69 62          	add    %ch,0x62(%rcx,%rbp,2)
 556:	73 74                	jae    5cc <_init-0xa34>
 558:	64 63 2b             	movsxd %fs:(%rbx),%ebp
 55b:	2b 2e                	sub    (%rsi),%ebp
 55d:	73 6f                	jae    5ce <_init-0xa32>
 55f:	2e 36 00 6c 69 62    	cs ss add %ch,0x62(%rcx,%rbp,2)
 565:	6d                   	insl   (%dx),%es:(%rdi)
 566:	2e 73 6f             	jae,pn 5d8 <_init-0xa28>
 569:	2e 36 00 6c 69 62    	cs ss add %ch,0x62(%rcx,%rbp,2)
 56f:	67 63 63 5f          	movsxd 0x5f(%ebx),%esp
 573:	73 2e                	jae    5a3 <_init-0xa5d>
 575:	73 6f                	jae    5e6 <_init-0xa1a>
 577:	2e 31 00             	cs xor %eax,(%rax)
 57a:	6c                   	insb   (%dx),%es:(%rdi)
 57b:	69 62 63 2e 73 6f 2e 	imul   $0x2e6f732e,0x63(%rdx),%esp
 582:	36 00 47 4c          	ss add %al,0x4c(%rdi)
 586:	49                   	rex.WB
 587:	42                   	rex.X
 588:	43 5f                	rex.XB pop %r15
 58a:	32 2e                	xor    (%rsi),%ch
 58c:	33 34 00             	xor    (%rax,%rax,1),%esi
 58f:	47                   	rex.RXB
 590:	4c                   	rex.WR
 591:	49                   	rex.WB
 592:	42                   	rex.X
 593:	43 5f                	rex.XB pop %r15
 595:	32 2e                	xor    (%rsi),%ch
 597:	32 2e                	xor    (%rsi),%ch
 599:	35 00 2f 68 6f       	xor    $0x6f682f00,%eax
 59e:	6d                   	insl   (%dx),%es:(%rdi)
 59f:	65 2f                	gs (bad)
 5a1:	66 72 61             	data16 jb 605 <_init-0x9fb>
 5a4:	6e                   	outsb  %ds:(%rsi),(%dx)
 5a5:	63 6f 69             	movsxd 0x69(%rdi),%ebp
 5a8:	73 2f                	jae    5d9 <_init-0xa27>
 5aa:	44 6f                	rex.R outsl %ds:(%rsi),(%dx)
 5ac:	63 75 6d             	movsxd 0x6d(%rbp),%esi
 5af:	65 6e                	outsb  %gs:(%rsi),(%dx)
 5b1:	74 73                	je     626 <_init-0x9da>
 5b3:	2f                   	(bad)
 5b4:	55                   	push   %rbp
 5b5:	6e                   	outsb  %ds:(%rsi),(%dx)
 5b6:	69 76 65 72 73 69 74 	imul   $0x74697372,0x65(%rsi),%esi
 5bd:	79 20                	jns    5df <_init-0xa21>
 5bf:	28 52 65             	sub    %dl,0x65(%rdx)
 5c2:	61                   	(bad)
 5c3:	6c                   	insb   (%dx),%es:(%rdi)
 5c4:	29 2f                	sub    %ebp,(%rdi)
 5c6:	53                   	push   %rbx
 5c7:	65 6d                	gs insl (%dx),%es:(%rdi)
 5c9:	65 73 74             	gs jae 640 <_init-0x9c0>
 5cc:	65 72 20             	gs jb  5ef <_init-0xa11>
 5cf:	39 2f                	cmp    %ebp,(%rdi)
 5d1:	43 6f                	rex.XB outsl %ds:(%rsi),(%dx)
 5d3:	6d                   	insl   (%dx),%es:(%rdi)
 5d4:	70 20                	jo     5f6 <_init-0xa0a>
 5d6:	34 30                	xor    $0x30,%al
 5d8:	30 2f                	xor    %ch,(%rdi)
 5da:	44 6c                	rex.R insb (%dx),%es:(%rdi)
 5dc:	6c                   	insb   (%dx),%es:(%rdi)
 5dd:	20 70 72             	and    %dh,0x72(%rax)
 5e0:	61                   	(bad)
 5e1:	63 74 69 63          	movsxd 0x63(%rcx,%rbp,2),%esi
 5e5:	65 2f                	gs (bad)
 5e7:	43 2b 2b             	rex.XB sub (%r11),%ebp
 5ea:	2f                   	(bad)
 5eb:	63 72 65             	movsxd 0x65(%rdx),%esi
 5ee:	61                   	(bad)
 5ef:	74 65                	je     656 <_init-0x9aa>
 5f1:	5f                   	pop    %rdi
 5f2:	64 79 6e             	fs jns 663 <_init-0x99d>
 5f5:	61                   	(bad)
 5f6:	6d                   	insl   (%dx),%es:(%rdi)
 5f7:	69 63 2f 6c 69 62 00 	imul   $0x62696c,0x2f(%rbx),%esp

Disassembly of section .gnu.version:

00000000000005fe <.gnu.version>:
 ...
 60a:	01 00                	add    %eax,(%rax)
 60c:	01 00                	add    %eax,(%rax)
 60e:	01 00                	add    %eax,(%rax)
...
0000000000000640 <.rela.dyn>:
 ...
 67f:	00 20                	add    %ah,(%rax)
 681:	40 00 00             	rex add %al,(%rax)
 684:	00 00                	add    %al,(%rax)
 686:	00 00                	add    %al,(%rax)
 688:	c0 3f 00             	sarb   $0x0,(%rdi)
 68b:	00 00                	add    %al,(%rax)
 68d:	00 00                	add    %al,(%rax)
 68f:	00 06                	add    %al,(%rsi)
...
0000000000001040 <_Z10subNumbersii@plt>:
    1040:	ff 25 c2 2f 00 00    	jmp    *0x2fc2(%rip)        # 4008 <_Z10subNumbersii@Base>
    1046:	68 01 00 00 00       	push   $0x1
    104b:	e9 d0 ff ff ff       	jmp    1020 <_init+0x20>

0000000000001050 <_Z10addNumbersii@plt>:
    1050:	ff 25 ba 2f 00 00    	jmp    *0x2fba(%rip)        # 4010 <_Z10addNumbersii@Base>
...
0000000000001060 <_start>:
    ...
    107f:	ff 15 43 2f 00 00    	call   *0x2f43(%rip)        # 3fc8 <__libc_start_main@GLIBC_2.34>
    1085:	f4                   	hlt
    ...
    1122:	ff 15 98 2e 00 00    	call   *0x2e98(%rip)        # 3fc0 <__cxa_finalize@GLIBC_2.2.5>
...
0000000000001159 <main>:
    ...
    1161:	be 05 00 00 00       	mov    $0x5,%esi
    1166:	bf 03 00 00 00       	mov    $0x3,%edi
    116b:	e8 e0 fe ff ff       	call   1050 <_Z10addNumbersii@plt>
    1170:	89 45 f8             	mov    %eax,-0x8(%rbp)
    1173:	be 05 00 00 00       	mov    $0x5,%esi
    1178:	bf 03 00 00 00       	mov    $0x3,%edi
    117d:	e8 be fe ff ff       	call   1040 <_Z10subNumbersii@plt>
...
0000000000002018 <__GNU_EH_FRAME_HDR>:
    ...
    201c:	24 00                	and    $0x0,%al
    201e:	00 00                	add    %al,(%rax)
    2020:	03 00                	add    (%rax),%eax
    2022:	00 00                	add    %al,(%rax)
    2024:	08 f0                	or     %dh,%al
    2026:	ff                   	(bad)
    2027:	ff 58 00             	lcall  *0x0(%rax)
    202a:	00 00                	add    %al,(%rax)
    202c:	48                   	rex.W
    202d:	f0 ff                	lock (bad)
    202f:	ff 40 00             	incl   0x0(%rax)
    2032:	00 00                	add    %al,(%rax)
    2034:	41 f1                	rex.B int1
    2036:	ff                   	(bad)
    2037:	ff                   	.byte 0xff
    2038:	80 00 00             	addb   $0x0,(%rax)
	...
...
0000000000002040 <.eh_frame>:
    ...
    204d:	78 10                	js     205f <__GNU_EH_FRAME_HDR+0x47>
    ...
    207a:	ff                   	(bad)
    207b:	ff 40 00             	incl   0x0(%rax)
    207e:	00 00                	add    %al,(%rax)
    2080:	00 0e                	add    %cl,(%rsi)
...
0000000000003d90 <_DYNAMIC>:
    ...
    3e07:	00 a8 11 00 00 00    	add    %ch,0x11(%rax)
    3e0d:	00 00                	add    %al,(%rax)
    3e0f:	00 19                	add    %bl,(%rcx)
    3e11:	00 00                	add    %al,(%rax)
    3e13:	00 00                	add    %al,(%rax)
    3e15:	00 00                	add    %al,(%rax)
    3e17:	00 80 3d 00 00 00    	add    %al,0x3d(%rax)
    ...
    3e37:	00 88 3d 00 00 00    	add    %cl,0x3d(%rax)
    ...
    3e5f:	00 05 00 00 00 00    	add    %al,0x0(%rip)        # 3e65 <_DYNAMIC+0xd5>
...
0000000000003fe8 <_GLOBAL_OFFSET_TABLE_>:
    3fe8:	90                   	nop
    3fe9:	3d 00 00 00 00       	cmp    $0x0,%eax
	...
